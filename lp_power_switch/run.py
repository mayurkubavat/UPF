...
def compile_files():
    ...
    os.system("vopt -work work  +acc -pa_enable=highlight+debug test -pa_upf design_top.upf -pa_top \"/test/dut_top\"  -pa_lib work -o testO")


def simulate():
    if args.gui:
        os.system("vsim -pa_debugdir padebug -pa work.testO -do \"log -r /*; run -all;\"")
    else:
        os.system("vsim -pa_debugdir padebug -pa work.testO -c -do \"run -all; exit;\"")
